      ...
      {submitted ? (
        ...
        <form onSubmit={handleSubmit} className="flex gap-2 max-w-md mx-auto">
          <input
            ...
            className="flex-1 px-4 py-2.5 bg-slate-900/80 border border-dark-border rounded-xl text-sm text-slate-200 placeholder:text-slate-500 focus:outline-none focus:border-accent-blue focus:ring-1 focus:ring-accent-blue transition-colors"
          />
          <button
            type="submit"
